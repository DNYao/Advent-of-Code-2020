...
def findMore2020(input):
    '''
    Part 2 of the Day 1 puzzle - find 3 numbers that sum to 2020. Also quick and dirty with no duplicate checking
    :param input: list of numbers
    '''
    for i in range(len(input)):
        for j in range(len(input)):
